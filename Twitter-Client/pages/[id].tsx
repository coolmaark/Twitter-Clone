...
const UserProfilePage: NextPage<ServerProps> = (props) => {
  ...
  const handleFollowUser = useCallback(async () => {
    if (!props.userInfo?.id) {
      console.error('userInfo or userInfo.id is undefined');
      return;
    }
    if (!graphqlClient?.request) {
      console.error("graphqlClient or request is undefined");
      return;
    }
    console.log("graphqlClient:", graphqlClient);
  console.log("unfollowUserMutation:", unfollowUserMutation);
          ...
          <div className="p-4 border-b border-slate-800">
            ...
            <div className="flex justify-between items-center">
              <div className="flex gap-4 mt-2 text-sm text-gray-400">
                <span>{props.userInfo?.follower?.length} follower</span>
